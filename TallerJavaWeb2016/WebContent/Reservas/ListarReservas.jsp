...
<body>
	...
	<table style="">
		<tr>
			<td colspan="2"><a href="/TallerJavaWeb2016/Reservas/AltaReserva.jsp">Agregar</a><br></td>
		</tr>
		<tr>
			<td colspan="2">
				<table style="width: 100%">
					...
					<%
						Vector coleccion_reservas_vector = ms.devolver_Vector_Reservas();
						for (Enumeration e = coleccion_reservas_vector.elements(); e.hasMoreElements();) {
